(self["webpackChunkgulp_builder"] = self["webpackChunkgulp_builder"] || []).push([["src_js_components_anime-pages_js"],{

/***/ "./src/js/components/anime-pages.js":
/*!******************************************!*\
  !*** ./src/js/components/anime-pages.js ***!
  \******************************************/
/***/ (() => {
...
class AnimePageUpd {
  render() {
    ...
    pageArray.forEach(e => {
      ...
      document.querySelector('.anime-page__short-sheet-list-item-ep').innerHTML = `${e.series.last}/${e.series.all}`;
...
//# sourceMappingURL=src_js_components_anime-pages_js.main.js.map